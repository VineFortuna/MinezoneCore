...
public enum FishType {
    ...
    FROG(40, "Frog", FishRarity.COMMON, Arrays.asList(FishArea.Pond, FishArea.LushCave, FishArea.Park, FishArea.Woods)),
    PICKLES(8, "Sea Pickles", FishRarity.RARE, Arrays.asList(FishArea.Pond, FishArea.LushCave)),
    SQUID(9, "Squid", FishRarity.RARE, Arrays.asList(FishArea.Pond)),
    ...
    LOBSTER(13, "Lobster", FishRarity.RARE, Arrays.asList(FishArea.Pond, FishArea.Shores)),
    CRAB(14, "Crab", FishRarity.RARE, Arrays.asList(FishArea.Pond, FishArea.Shores)),
    OARFISH(41, "Oarfish", FishRarity.RARE, Arrays.asList(FishArea.Pond)),
    GOLDFISH(48, "Goldfish", FishRarity.RARE, Arrays.asList(FishArea.Pond, FishArea.Woods)),
    HERMITCRAB(15, "Hermit Crab", FishRarity.EPIC, Arrays.asList(FishArea.Shores)),
    ...
    OCTOPUS(19, "Octopus", FishRarity.EPIC, Arrays.asList(FishArea.Shores)),
    SNAKE(43, "Sea Snake", FishRarity.EPIC, null),
    PARROTFISH(47, "Parrotfish", FishRarity.EPIC, Arrays.asList(FishArea.LushCave)),
    CLAM(49, "Clam", FishRarity.EPIC, Arrays.asList(FishArea.Pond, FishArea.Shores)),
    ...
    ANEMONE(50, "Sea Anemone", FishRarity.MYTHIC, Arrays.asList(FishArea.LushCave)),
    ...
    BOTTLE(30, "Empty Bottle", FishRarity.JUNK, Arrays.asList(FishArea.Pond, FishArea.Park, FishArea.Shores)),
    BOOTS(31, "Old Boots", FishRarity.JUNK, Arrays.asList(FishArea.Pond, FishArea.Park, FishArea.Shores)),
