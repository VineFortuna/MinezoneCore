...
public class Leaderboard extends LeaderboardBase {
    ...
    private static final Location TITLE_LOC = new Location(null, 185.5, 106.5, 685.5);
    ...
    public void updateLeaderboard(boolean init) {
        ...
        for (int i = 0; i < lifetimeTopIds.size() && rank <= 10; i++, rank++) {
            ...
            Integer v = lifetimeWins.getOrDefault(id, 0);
    ...
    public void showToViewer(Player viewer, LeaderboardScope scope) {
        ...
        // Reset line (spaced to avoid Z-fighting)
