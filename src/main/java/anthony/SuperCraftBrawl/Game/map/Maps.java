...
public enum Maps {
	...
	Burrows(
			...
			Size.SMALL,
			Category.CURATED,
			new ItemStack(Material.DIRT, 1, (short) 1),
			new MapInstance(
					"burrows")
					.setSpawnPos(
	...
	CandyOverdose(
			...
			Size.MEDIUM,
			Category.CURATED,
			new ItemStack(Material.WOOL, 1,(short) 3), // Light Blue Wool
			new MapInstance(
					"candyoverdose")
					.setSpawnPos(
	...
	NorthernSeas(
			...
			Size.LARGE,
			Category.CASUAL,
			new ItemStack(Material.WOOL, 1, (short) 15), // Black Wool
			new MapInstance(
					"northernseas")
					.setSpawnPos(
	...
	CandyLand(
			...
			Size.MEDIUM,
			Category.CURATED,
			new ItemStack(Material.WOOL, 1, (short) 6), // Pink Wool
			new MapInstance(
					"candylandclassic")
					.setSpawnPos(
	...
	CliffSide(
			...
			Size.MEDIUM,
			Category.CASUAL,
			new ItemStack(Material.STONE, 1, (short) 5), // Andesite
			new MapInstance(
					"cliffside")
					.setSpawnPos(
	...
	Stronghold(
			...
			Size.SMALL,
			Category.CURATED,
			new ItemStack(Material.MONSTER_EGGS, 1, (short) 4), // Cracked Stone Brick
			new MapInstance(
					"stronghold")
					.setSpawnPos(
	...
	Marooned(
			...
			Size.MEDIUM,
			Category.CASUAL,
			new ItemStack(Material.STAINED_GLASS, 1, (short) 11), // Light Blue Glass
			new MapInstance(
					"marooned")
					.setSpawnPos(
							new Vector(41, 98, 2),
	...
	Orbital(
			...
			Size.SMALL,
			Category.CURATED,
			new ItemStack(Material.STAINED_GLASS, 1, (short) 2), // Magenta Glass
			new MapInstance(
					"orbital")
					.setSpawnPos(
					...
					.setSignLoc(new Vector(165.523, 106, 690.700))
					.setSource(MapSource.MINECADE)
	...
	SandTemple("SandTemple",
			...
			new MapInstance(
					...
					.setSignLoc(new Vector(165.523, 107, 690.700))
					.setSource(MapSource.COMMUNITY)
					.setGameType(GameType.DUEL)
	),
	...
	Waterfall(
			...
			Size.LARGE,
			Category.CURATED,
			new ItemStack(Material.STAINED_GLASS, 1, (short) 3), // Light Blue Glass
			new MapInstance(
					"waterfall")
					.setSpawnPos(
	...
	Canyon(
			...
			Size.SMALL,
			Category.CURATED,
			new ItemStack(Material.STAINED_CLAY, 1, (short) 1), // Orange Clay
			new MapInstance(
					"canyon")
					.setSpawnPos(
	...
	HighIslands(
			...
			Size.MEDIUM,
			Category.CASUAL,
			new ItemStack(Material.HUGE_MUSHROOM_1, 1, (short) 6),
			new MapInstance(
					"highislands")
					.setSpawnPos(
	...
	Gateway(
			...
			new MapInstance(
					...
					.setSignLoc(new Vector(164.478, 106, 690.700))
					.setSource(MapSource.MINECADE)
					.setGameType(GameType.DUEL)
	),
	...
	PaintBoardOG(
			...
			Size.SMALL,
			Category.VAULTED,
			new ItemStack(Material.WOOL, 1, (short) 2), // Magenta Wool
			new MapInstance(
					"paintboardog")
					.setSpawnPos(
	...
	SimpleLand(
			...
			Size.SMALL,
			Category.CURATED,
			new ItemStack(Material.STAINED_CLAY, 1, (short) 5), // Lime Clay
			new MapInstance(
					"simpleland")
					.setSpawnPos(
	...
	Pokemob(
			...
			Size.SMALL,
			Category.CASUAL,
			new ItemStack(Material.WOOL, 1, (short) 14), // Red Wool
			new MapInstance(
					"pokemob")
					.setSpawnPos(
	...
	Elven(
			...
			Size.HUGE,
			Category.VAULTED,
			new ItemStack(Material.LOG, 1, (short) 3), // Jungle Log
			new MapInstance(
					"elven")
					.setSpawnPos(
	...
	Treehouse(
			...
			Size.HUGE,
			Category.VAULTED,
			new ItemStack(Material.WOOD, 1, (short) 2), // Birch Wood
			new MapInstance(
					"treehouse")
					.setSpawnPos(
	...
	LostTemple(
			...
			Size.LARGE,
			Category.VAULTED,
			new ItemStack(Material.SMOOTH_BRICK, 1, (short) 1), // Mossy Stone Brick
			new MapInstance(
					"losttemple")
					.setSpawnPos(
	...
	WaterShrine(
			...
			Size.MEDIUM,
			Category.CASUAL,
			new ItemStack(Material.PRISMARINE, 1, (short) 1), // Prismarine Brick
			new MapInstance(
					"watershrine")
					.setSpawnPos(
					...
					.setSignLoc(new Vector(163.517, 107, 690.700))
					.setSource(MapSource.COMMUNITY)
					.setGameType(GameType.DUEL)
	),
	...
	TiltedTowers(
			...
			Size.HUGE,
			Category.VAULTED,
			new ItemStack(Material.STAINED_CLAY, 1, (short) 9), // Cyan Clay (grey-ish)
			new MapInstance(
					"tilted")
					.setSpawnPos(
	...
	CommCollab(
			...
			Size.MEDIUM,
			Category.VAULTED,
			new ItemStack(Material.STAINED_GLASS, 1, (short) 1), // Orange Glass
			new MapInstance(
					"communitycollab")
					.setSpawnPos(
	...
	SandStorm(
			...
			new MapInstance(
					...
					.setSignLoc(new Vector(162.437, 106, 690.700))
					.setSource(MapSource.COMMUNITY)
					.setGameType(GameType.DUEL)
	),
	...
	CherryGrove(
			...
			Size.MEDIUM,
			Category.CASUAL,
			new ItemStack(Material.STAINED_GLASS, 1, (short) 6), // Pink Wool
			new MapInstance(
					"cherrygrove")
					.setSpawnPos(
	...
	Mansion(
			...
			Size.MEDIUM,
			Category.CASUAL,
			new ItemStack(Material.WOOD, 1, (short) 1), // Spruce Wood
			new MapInstance(
					"mansion")
					.setSpawnPos(
	...
	TempleOfMars(
			...
			Size.SMALL,
			Category.CURATED,
			new ItemStack(Material.QUARTZ_BLOCK, 1, (short) 2), // Quartz Pillar
			new MapInstance(
					"templeofmars")
					.setSpawnPos(
	...
	Slither(
			...
			Size.MEDIUM,
			Category.CASUAL,
			new ItemStack(Material.STAINED_CLAY, 1, (short) 14), // Red Clay
			new MapInstance(
					"slither")
					.setSpawnPos(
