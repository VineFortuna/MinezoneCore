...
public enum Maps {
	...
	HauntedMansion("HauntedMansion",
			new MapInstance("hauntedmansion")
					...
					.setSignLoc(new Vector(175.503, 108, 673.700)).setMapType(MapType.COMMUNITY)),
	...
	CliffSide("CliffSide",
			new MapInstance("cliffside")
					...
					.setSignLoc(new Vector(177.495, 106, 673.700)).setMapType(MapType.COMMUNITY)),
	...
	Marooned("Marooned",
			new MapInstance("marooned")
					...
					.setBounds(new Vector(70.500, 116, 7.500), 60, 60).setSignLoc(new Vector(175.503, 106, 673.700))
	...
	Orbital("Orbital", new MapInstance("orbital")
			...
			.setBounds(new Vector(55.484, 113, 6.503), 35, 50).setSignLoc(new Vector(168.300, 106, 669.523))
			.setMapType(MapType.DUEL).setGameType(GameType.DUEL)),
	...
	SandTemple("SandTemple",
			new MapInstance("sandtemple")
					...
					.setBounds(new Vector(-5.480, 123, 8.448), 40, 30).setSignLoc(new Vector(168.300, 106, 667.580))
					.setMapType(MapType.DUEL).setGameType(GameType.DUEL)),
	...
	BlossomHill("BlossomHill",
			new MapInstance("blossomhill")
					.setSpawnPos(new Vector(349.429, 142, 172.509), new Vector(335.550, 146, 160.985),
							new Vector(327.473, 133, 140.444), new Vector(317.471, 140, 160.372),
							new Vector(344.456, 132, 196.486), new Vector(366.493, 132, 183.455))
					.setLobbyLoc(new Vector(268.518, 164, 160.504)).setSpecLoc(new Vector(344.500, 163, 160.500))
					.setBounds(new Vector(344.500, 163, 160.500), 40, 60).setSignLoc(new Vector(176.481, 106, 673.700))
					.setMapType(MapType.COMMUNITY)),
	...
	BlossomHillF("BlossomHill",
			new MapInstance("blossomhill")
					.setSpawnPos(new Vector(349.429, 142, 172.509), new Vector(335.550, 146, 160.985),
							...
							new Vector(344.456, 132, 196.486), new Vector(366.493, 132, 183.455))
					.setLobbyLoc(new Vector(268.518, 164, 160.504)).setSpecLoc(new Vector(344.500, 163, 160.500))
					.setBounds(new Vector(344.500, 163, 160.500), 40, 60).setSignLoc(new Vector(196.474, 106, 673.700))
					.setMapType(MapType.FRENZY).setGameType(GameType.FRENZY)),

	Tropical("Tropical",
			new MapInstance("tropical")
					.setSpawnPos(new Vector(408.509, 101, 122.405), new Vector(436.509, 82, 156.559),
							new Vector(422.545, 82, 173.471), new Vector(380.358, 80, 155.491),
							new Vector(404.051, 96, 157.006), new Vector(424.504, 84, 140.493))
					.setLobbyLoc(new Vector(333.583, 90, 154.515)).setSpecLoc(new Vector(403.845, 124.41554, 157.094))
					.setBounds(new Vector(404.461, 123, 152.472), 50, 50).setSignLoc(new Vector(200.504, 106, 673.700))
	...
	Gateway("Gateway",
			new MapInstance("gateway")
					...
					.setLobbyLoc(new Vector(369.458, 115, 258.441)).setSpecLoc(new Vector(372.435, 100, 188.626))
					.setBounds(new Vector(372.483, 128, 188.497), 50, 50).setSignLoc(new Vector(168.300, 106, 670.508))
					.setMapType(MapType.DUEL).setGameType(GameType.DUEL)),
	...
	PaintBoardOG("PaintBoardOG",
			new MapInstance("paintboardog")
					...
					.setLobbyLoc(new Vector(380.502, 151, 301.543)).setSpecLoc(new Vector(373.500, 158, 240.500))
					.setBounds(new Vector(373.500, 158, 240.500), 50, 30).setSignLoc(new Vector(168.300, 106, 669.556))
	...
	SimpleLand("SimpleLand",
			new MapInstance("simpleland")
					...
					.setLobbyLoc(new Vector(392.484, 175, 320.476)).setSpecLoc(new Vector(392.500, 150, 260.500))
					.setBounds(new Vector(392.500, 167, 260.500), 40, 40).setSignLoc(new Vector(168.300, 107, 667.580))
					.setGameType(GameType.CLASSIC)),
	...
	Pokemob("Pokemob",
			new MapInstance("pokemob")
					...
					.setLobbyLoc(new Vector(286.560, 113, 254.505)).setSpecLoc(new Vector(362.537, 117, 230.920))
					.setBounds(new Vector(353.450, 125, 254.414), 50, 50).setSignLoc(new Vector(192.516, 106, 673.700))
					.setMapType(MapType.SCB)),
	...
	Atronach("Atronach",
			new MapInstance("atronach2")
					...
					.setBounds(new Vector(55.500, 174, -57.500), 58, 58).setSignLoc(new Vector(184.568, 106, 673.700))
					.setMapType(MapType.FRENZY).setGameType(GameType.FRENZY)),

	SnowGlobe("SnowGlobe", new MapInstance("snowglobe")
			.setSpawnPos(new Vector(57.534, 97, -58.306), new Vector(56.528, 85, -28.124),
					new Vector(72.410, 87, -36.435), new Vector(59.537, 88, -45.849), new Vector(71.164, 82, -65.119),
					new Vector(56.558, 101, -47.634), new Vector(65.324, 86, -70.961), new Vector(59.461, 87, -45.481),
					new Vector(50.451, 87, -66.228))
			.setLobbyLoc(new Vector(57.475, 109.31250, -130.494)).setSpecLoc(new Vector(66.578, 100, -34.391))
			.setBounds(new Vector(55.500, 174, -57.500), 58, 58).setMapType(MapType.FRENZY)
			.setGameType(GameType.FRENZY)),
	...
	Elven("Elven", new MapInstance("elven")
			...
			.setBounds(new Vector(-22.500, 254, 1.500), 100, 100).setSignLoc(new Vector(182.542, 107, 673.700))
			.setMapType(MapType.FRENZY).setGameType(GameType.FRENZY)),
	...
	Limbo("Limbo",
			new MapInstance("limbo")
					...
					.setBounds(new Vector(24.500, 162, -155.500), 60, 60).setSignLoc(new Vector(183.513, 107, 673.700))
					.setMapType(MapType.FRENZY).setGameType(GameType.FRENZY)),
	...
	Treehouse("Treehouse",
			new MapInstance("treehouse")
					...
					.setBounds(new Vector(-45.518, 173, 162.461), 60, 58).setSignLoc(new Vector(183.513, 108, 673.700))
					.setMapType(MapType.FRENZY).setGameType(GameType.FRENZY)),
	...
	Frigid("Frigid",
			new MapInstance("frigid")
					...
					.setBounds(new Vector(-43.545, 146, 92.435), 70, 70).setSignLoc(new Vector(184.568, 107, 673.700))
					.setMapType(MapType.FRENZY).setGameType(GameType.FRENZY)),
	...
	FoundTemple("FoundTemple", new MapInstance("losttemple")
			...
			.setBounds(new Vector(1015.500, 224, -1044.500), 65, 65).setSignLoc(new Vector(182.542, 106, 673.700))
			.setMapType(MapType.FRENZY).setGameType(GameType.FRENZY)),

	Crescent("Crescent",
			new MapInstance("crescent")
					.setSpawnPos(new Vector(5068.115, 129, 712.473), new Vector(5020.488, 129, 696.607),
							new Vector(5036.411, 129, 712.445), new Vector(5052.421, 129, 727.483),
							new Vector(5068.418, 129, 680.417), new Vector(5035.693, 129, 678.955),
							new Vector(5052.359, 141, 696.622))
					.setLobbyLoc(new Vector(5051.459, 129, 623.500)).setSpecLoc(new Vector(5050.500, 141, 686.500))
					.setBounds(new Vector(5052.500, 141, 696.500), 45, 45).setSignLoc(new Vector(-48.507, 128, -28.700))
					.setMapType(MapType.COMMUNITY)),
	...
	WaterShrine("WaterShrine",
			new MapInstance("watershrine")
					...
					.setBounds(new Vector(5052.006, 150, 594.466), 30, 35).setSignLoc(new Vector(168.300, 107, 668.496))
	...
	TiltedTowers("TiltedTowers",
			new MapInstance("tilted")
					...
					.setSignLoc(new Vector(184.568, 108, 673.700)).setGameType(GameType.FRENZY)),
	...
	PaintBoard("PaintBoard",
			new MapInstance("paintboard")
					...
					.setBounds(new Vector(5027.500, 157, 628.500), 30, 50).setSignLoc(new Vector(168.300, 107, 669.523))
					.setMapType(MapType.COMMUNITY).setGameType(GameType.DUEL)),
	...
	CommCollab("CommCollab",
			new MapInstance("communitycollab")
					...
					.setSignLoc(new Vector(177.495, 108, 673.700)).setMapType(MapType.COMMUNITY)),
	...
	Apex("Apex", new MapInstance("apex")
			...
			.setBounds(new Vector(5038.500, 143, 676.500), 50, 45).setSignLoc(new Vector(194.555, 108, 673.700))
			.setMapType(MapType.COMMUNITY)),

	NetherFortress("NetherFortress",
			new MapInstance("netherfortress")
					.setSpawnPos(new Vector(5031.383, 146, 585.477), new Vector(5060.463, 131, 591.422),
							new Vector(5065.498, 146, 630.511), new Vector(5038.497, 146, 635.504),
							new Vector(5059.595, 146, 606.429), new Vector(5038.436, 139, 591.371))
					.setLobbyLoc(new Vector(5000.521, 157, 597.435)).setSpecLoc(new Vector(5050.741, 160, 606.475))
					.setBounds(new Vector(5052.502, 160, 610.468), 30, 45).setSignLoc(new Vector(209.700, 106, 668.489))
					.setMapType(MapType.SETHBLING)),

	Plains("Plains",
			new MapInstance("plains").setSpawnPos(new Vector(26.542, 167, -84.494), new Vector(-6.535, 167, -84.533))
					.setLobbyLoc(new Vector(12.536, 186, -150.517)).setSpecLoc(new Vector(10.500, 176, -84.500))
					.setBounds(new Vector(10.500, 176, -84.500), 50, 35).setSignLoc(new Vector(168.300, 107, 667.546))
					.setGameType(GameType.DUEL).setMapType(MapType.COMMUNITY)),

	SandStorm("SandStorm",
			new MapInstance("sandstorm")
					.setSpawnPos(new Vector(-11.576, 176, -80.546), new Vector(30.519, 176, -80.498))
					.setLobbyLoc(new Vector(12.525, 187, -150.471)).setSpecLoc(new Vector(9.500, 183, -80.500))
					.setBounds(new Vector(9.500, 183, -80.500), 50, 30).setSignLoc(new Vector(168.300, 107, 670.508))
					.setGameType(GameType.DUEL).setMapType(MapType.COMMUNITY)),
	...
	PileOfBodies("PileOfBodies", new MapInstance("pileofbodies")
			...
			.setBounds(new Vector(4947.534, 162, 548.541), 60, 60).setSignLoc(new Vector(201.537, 107, 673.700))
			.setMapType(MapType.SETHBLING)),
	...
	MushroomCastle("MushroomCastle", new MapInstance("mushroomcastle")
			...
			.setBounds(new Vector(4909.448, 195, 876.408), 40, 40).setSignLoc(new Vector(168.300, 106, 668.496))
			.setMapType(MapType.DUEL).setGameType(GameType.DUEL)),
	...
	CherryGrove("CherryGrove", new MapInstance("cherrygrove")
			.setSpawnPos(new Vector(4574.493, 190, 724.400), new Vector(4579.587, 204, 720.403),
					new Vector(4596.408, 189, 743.549), new Vector(4612.459, 184, 773.403),
					new Vector(4624.472, 205, 785.549))
			.setLobbyLoc(new Vector(4517.374, 197, 746.590)).setSpecLoc(new Vector(4574.500, 193, 736.498))
			.setBounds(new Vector(4592.500, 224, 743.500), 50, 70).setSignLoc(new Vector(200.504, 108, 673.700))),
	...
	Mountain("Mountain", new MapInstance("mountain")
			...
			.setBounds(new Vector(4885.436, 158, 790.454), 45, 40).setSignLoc(new Vector(200.504, 107, 673.700))),
	...
	TempleOfMars("TempleOfMars", new MapInstance("templeofmars")
			.setSpawnPos(new Vector(4946.934, 151, 749.479), new Vector(4946.502, 153, 788.490),
	...
	ColdWar("ColdWar", new MapInstance("coldwar")
			...
			.setBounds(new Vector(1000.500, 162, 706.500), 60, 50).setSignLoc(new Vector(199.535, 106, 673.700))),
	...
	SantasWorkshop("SantasWorkshop",
			new MapInstance("santafactory")
					.setSpawnPos(new Vector(55.541, 83.5, -83.159), new Vector(73, 86, -43), new Vector(55, 77, -5),
							new Vector(35, 82, -51), new Vector(50, 74, -19), new Vector(74, 74, -62),
							new Vector(55, 74, -47), new Vector(33, 82, -21))
					.setLobbyLoc(new Vector(57, 85, -150)).setSpecLoc(new Vector(55.654, 101, -50.585))
					.setSignLoc(new Vector(201.537, 107, 673.700)).setBounds(new Vector(55, 74, -43), 100, 100)),
	Slither("Slither", new MapInstance("slither")
			.setSpawnPos(new Vector(68.402, 153, -135.507), new Vector(71.428, 151, -152.500),
					new Vector(89.496, 146, -170.644), new Vector(86.463, 144, -156.639),
					new Vector(108.003, 146, -146.034), new Vector(96.438, 147, -136.491))
			.setLobbyLoc(new Vector(12.555, 184, -150.462)).setSpecLoc(new Vector(97.411, 171, -152.539))
			.setBounds(new Vector(97.411, 171, -152.539), 55, 100).setSignLoc(new Vector(174.510, 106, 673.700)))
