...
import anthony.flagwars.shop.FWTeamUpgrade;
...
public class FWTeam {
	...
	private final Map<FWTeamUpgrade, Integer> upgradeTiers = new EnumMap<>(FWTeamUpgrade.class);
	...
	public FWTeam(int siteId, String name, DyeColor color, int capacity) {
		this.siteId = siteId;
		this.name = name;
		this.color = color;
	...
	public int getUpgradeTier(FWTeamUpgrade upgrade) {
		return upgradeTiers.getOrDefault(upgrade, upgrade.getBaseTier());
	}

	public void setUpgradeTier(FWTeamUpgrade upgrade, int tier) {
